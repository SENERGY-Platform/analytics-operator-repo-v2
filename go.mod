module github.com/SENERGY-Platform/analytics-operator-repo-v2

go 1.24.7

require (
	github.com/SENERGY-Platform/analytics-operator-repo-v2/lib v0.0.0-00010101000000-000000000000
...
replace github.com/SENERGY-Platform/analytics-operator-repo-v2/lib => ./lib
